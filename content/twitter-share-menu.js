 ...
 * Thin wrapper that configures the share menu integration module for Twitter
 */
...
/**
 * Initialize Twitter share menu integration
 */
async function init() {
  try {
    ...
    window.twitterIntegration = integration;
  } catch (error) {
